...
LOGIC_CONTENT = [
    ...
    ("Priority 1 - Task completeness",
     "If any task in the Taken sheet is NOT marked Completed = Yes, the CAPA is considered OPEN regardless of dates.", False),
    ("Priority 2 - All tasks completed",
     "If ALL tasks are marked Completed = Yes, the CAPA is CLOSED. Closed date = latest Date of completion among those tasks.", False),
    ("Priority 3 - Capas sheet fallback",
     "If there are no tasks (Taken sheet empty) or no completed task dates, use the Date closed field on the main Capas tab.", False),
    ("Priority 4 - Open",
     "If none of the above provide a date, the CAPA remains OPEN.", False),
    ("Status column",
